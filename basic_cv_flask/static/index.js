...
function updateImage() {
    ...
    img.onload = function () {
        ...
        var x = (canvas.width - img.width) * 0.5,   // this = image loaded
            y = (canvas.height - img.height) * 0.5;
...
function loadProcessedImage(data) {
    ...
    img.onload = function () {
        ...
        var x = (canvas.width - img.width) * 0.5,   // this = image loaded
            y = (canvas.height - img.height) * 0.5;
        var left = processedCanvas.width / 2 - w / 2;
        var top = processedCanvas.height / 2 - h / 2;
